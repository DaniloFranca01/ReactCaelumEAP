...
Devido às necessidades técnicas a aplicação foi convertida em API para ser consumida por um front-end em REACTjs. Sendo assim, dividimos em dois repositórios distintos. [Link para o repositório da API.](https://github.com/DaniloFranca01/ApiCaelumEAP)
